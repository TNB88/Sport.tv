# SportsTV + SPORT STREAM + GETOUT All-In-One v533 Source Fix

## File bàn giao

- APK: `SportsTV_5.2.3_BinhPro_SportStream_GetOut_AllInOne_v533_SourceFix.apk`
...
- Nguyên nhân bản 532: sau khi thêm GETOUT ở vị trí số 2, giao diện hiển thị playlist đã trừ đúng 3 vị trí nhưng click và nhấn giữ vẫn dùng công thức cũ `adapterPosition - 2`.
- Hậu quả: Truyền Hình TV mở nhầm Thanh TV; Thanh TV mở nhầm VietAnhTV; VietAnhTV có thể truy cập vượt danh sách nên màn hình đen hoặc lỗi.
- Đã sửa click và nhấn giữ playlist về `adapterPosition - 3`.
- Kiểm tra ánh xạ: Truyền Hình TV, Thanh TV và VietAnhTV đều mở đúng nguồn tương ứng.
- Phát thử Truyền Hình TV/VTV1: có hình và tiếng.
- Phát thử Thanh TV/Asian Games CH01: có hình và tiếng.
- Phát thử VietAnhTV: có hình và tiếng.
- Ba lần phát thử đều khởi tạo MediaCodec video/audio và không có `FATAL EXCEPTION`.
